...
const slide = [
    { img: '../assets/img/wide/wide-3.jpg', title: 'Orange Sunset', text: 'Lorem Ipsum asit dolor kimet' },
    { img: '../assets/img/wide/wide-2.jpg', title: 'Purple Skies', text: 'Lorem Ipsum asit dolor kimet' },
    { img: '../assets/img/wide/wide-1.jpg', title: 'Night Light', text: 'Lorem Ipsum asit dolor kimet' },
];
            ...
            <div className="ms-panel">
                ...
                <div className="ms-panel-body">
                    ...
                    <Carousel className="ms-arrow-slider" indicators={false}>
                        {slide.map((item, i) => (
                            <Carousel.Item key={i}>
                                <img className="d-block w-100" src={item.img} alt="Third slide" />
