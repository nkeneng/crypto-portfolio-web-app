            ...
            <main className="body-content ms-coming-soon">
                ...
                <div className="ms-content-wrapper">
                    ...
                    <ul className="ms-list-flex ms-social-container">
                        <li> <Link target="_blank" className="ms-social ms-fb" to="#"><i className="fab fa-facebook-f" /></Link> </li>
                        <li> <Link target="_blank" className="ms-social ms-pnt" to="#"><i className="fab fa-pinterest-p" /></Link> </li>
                        <li> <Link target="_blank" className="ms-social ms-tw" to="#"><i className="fab fa-twitter" /></Link> </li>
                        <li> <Link target="_blank" className="ms-social ms-wa" to="#"><i className="fab fa-whatsapp" /></Link> </li>
                        <li> <Link target="_blank" className="ms-social ms-skype" to="#"><i className="fab fa-skype" /></Link> </li>
                        <li> <Link target="_blank" className="ms-social ms-g-plus" to="#"><i className="fab fa-google-plus-g" /></Link> </li>
                    </ul>
                </div>
            </main>
        );
