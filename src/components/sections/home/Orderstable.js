                    ...
                    <Modal.Body>
                        <Form.Group
                            ...
                            <Form.Row style={{marginTop: "1rem"}}>
                                <div className="col">
                                    <Form.Label>Begin des Events</Form.Label>
                                    <InputGroup>
                                        <Form.Control
                                            required
                            ...
                            <Form.Row>
                                <div className="col-md-6">
                                    <div className="ms-form-group has-icon">
                                        ...
                                        <input type="text" value={newAsset.quantity} placeholder="0.00" className="form-control" name="quantity"
                                               onChange={e => {
                                ...
                                <div className="col-md-6">
                                    <div className="ms-form-group has-icon">
                                        ...
                                        <input value={newAsset.unitPrice} type="text" placeholder="0.00" className="form-control" name="price"
                                               onChange={e => {
                            ...
                            <Form.Row className={"mb-2"}>
                                <label>Frais</label>
                                <input value={newAsset.fees} type="text" placeholder="0.00" className="form-control" name="fees"
                                       onChange={e => {
